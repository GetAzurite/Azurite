...
namespace SmthDiff\Azurite\Commands;

use App\User;
use Illuminate\Console\Command;
use SmthDiff\Azurite\Models\Menu;
//use SmthDiff\Azurite\Models\Role;

class AzuriteInstall extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'azurite:install';
     ...
     * @var string
     */
    protected $description = 'Run installation of Azurite.';
    ...
    {
        $this->info('Please note: Azurite requires fresh Laravel installation!');
        $this->info('Starting installation process of Azurite...');
